...
class HeadingPlan(taskbase.TaskBase):
    def __init__(self, nav, waypoint = ll.LatLon(50.742810, 1.014469),  # somewhere in the solent
                 tack_line_offset = 0.01, target_radius = 2, tack_decision_samples = 200,
                 tack_decision_threshold = 0.75, waypoint_id = None, *args, **kwargs):
        ...
        *tack_decision_samples* and *tack_decision_threshold* control tack
        ...
        self.tack_voting = TackVoting(tack_decision_samples, int(tack_decision_threshold * tack_decision_samples))
